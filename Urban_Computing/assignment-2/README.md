[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/40C2ghkZ)
# Urban Computing Assignment 2

This repository contains the second assignment for the Urban Computing course in fall 2025. The excersises can be found in *"Assignment_2_SpatialData.ipynb"*.  The file *"lab_04_modified.ipynb"* is used in Task 3. To hand in your work you need to push *"Assignment_2_SpatialData.ipynb"* and its html version to GitHub classroom. You can do this via the build-in Git interface of VS Code, or by executing the following commands:
...
The repository must be pushed to the GitHub classroom before **October 21, at 23:59**. The code must run without issues after we create the development container. This means that any pip packages that are required to run your notebook must be included in the *"requirements.txt"* file.
