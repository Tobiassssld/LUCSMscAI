# vocal_separation_compare.py
# Assignment 3 – Voice Separation (Baseline + Improved)
# Author: [Your Name]
...
# === 2. Baseline voice separation using HPSS ===
...
# === 3. Improved version: frequency filtering + HPSS tuning ===
...
# === 5. (Optional) Apply to another track (track04) ===
...
print("✅ track04 separation complete.")
